...
import CameraAreaInterface from "@/components/features/scan/camera-area-interface";
import RecentAttendedUsersPanel from "@/components/features/scan/recent-attended-users-panel";
